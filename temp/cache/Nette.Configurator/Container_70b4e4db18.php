<?php
// source: C:\xampp\htdocs\photo\app/config/config.neon 
// source: C:\xampp\htdocs\photo\app/config/config.local.neon 

class Container_70b4e4db18 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\xampp\htdocs\photo\app',
			'wwwDir' => 'C:\xampp\htdocs\photo\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'C:\xampp\htdocs\photo\app/../temp',
		];
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp\htdocs\photo\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\photo\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\photo\app/../temp/cache',
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_70b4e4db18 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\xampp\htdocs\photo\app/../temp/cache/latte');
