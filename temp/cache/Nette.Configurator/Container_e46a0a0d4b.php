<?php
// source: C:\xampp2\htdocs\projekt\sandbox\app/config/config.neon 
// source: C:\xampp2\htdocs\projekt\sandbox\app/config/config.local.neon 

class Container_e46a0a0d4b extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\xampp2\htdocs\projekt\sandbox\app',
			'wwwDir' => 'C:\xampp2\htdocs\projekt\sandbox\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'C:\xampp2\htdocs\projekt\sandbox\app/../temp',
		];
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp2\htdocs\projekt\sandbox\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\xampp2\htdocs\projekt\sandbox\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp2\htdocs\projekt\sandbox\app/../temp/cache',
	...
	{
		return new Container_e46a0a0d4b_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_e46a0a0d4b_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_e46a0a0d4b $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('C:\xampp2\htdocs\projekt\sandbox\app/../temp/cache/latte');
